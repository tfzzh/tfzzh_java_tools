 ...
 * @dateTime 2014-3-27 下午8:47:12
 */
public class MessageAttributeTemplate extends BaseTemplate {
	 ...
	 * @param obj 相关对象
	 */
	public MessageAttributeTemplate(final String projectPath, final MessageToolBean obj) {
	...
	protected String getOutFileName() {
		return this.bean.getProName() + "MessageAttribute.java";
	}
}
