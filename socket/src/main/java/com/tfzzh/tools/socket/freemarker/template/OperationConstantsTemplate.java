 ...
 * @dateTime 2014-3-27 下午8:46:40
 */
public class OperationConstantsTemplate extends BaseTemplate {

	/**
	 * @author Weijie Xu
	 * @dateTime 2014-3-29 上午9:37:35
	 */
	private Collection<OperationTool> beans;
	 ...
	 * @param obj 需求的对象
	 */
	public OperationConstantsTemplate(final String projectPath, final Collection<OperationTool> obj) {
	...
	protected void setOverAllParam(final Object obj) {
		this.beans = (Collection<OperationTool>) obj;
	}
	...
	protected String getOutFilePath() {
		return SocketTemplateConstants.PROJECT_PATH_PREFIX + this.beans.iterator().next().getScopePathName() + "/tools/";
	}
	...
	protected String getOutFileName() {
		return this.beans.iterator().next().getScope().getProName() + "OperationConstants.java";
	}
}
