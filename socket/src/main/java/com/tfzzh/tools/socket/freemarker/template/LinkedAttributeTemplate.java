 ...
 * @dateTime 2014-3-27 下午8:47:12
 */
public class LinkedAttributeTemplate extends BaseTemplate {

	/**
	 * @author Weijie Xu
	 * @dateTime 2014-3-29 下午2:08:40
	 */
	private LinkedTool bean;
	 ...
	 * @param obj 相关对象
	 */
	public LinkedAttributeTemplate(final String projectPath, final LinkedTool obj) {
	...
	protected String getOutFilePath() {
		return SocketTemplateConstants.PROJECT_PATH_PREFIX + "/action/bean/attribute/";
	}
	...
	protected String getOutFileName() {
		return this.bean.getProMethodName() + "LinkedAttribute.java";
	}
}
