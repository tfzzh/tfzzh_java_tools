 ...
 * @dateTime 2014-3-27 下午8:47:12
 */
public class RequestNormalHttpMessageTemplate extends BaseTemplate {
	 ...
	 * @param obj 相关对象
	 */
	public RequestNormalHttpMessageTemplate(final String projectPath, final MessageToolBean obj) {
