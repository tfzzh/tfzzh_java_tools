 ...
 * @dateTime 2014-3-27 下午8:46:40
 */
public class MessageBeanConstantsTemplate extends BaseTemplate {
	 ...
	 * @param obj 需求的对象
	 */
	public MessageBeanConstantsTemplate(final String projectPath, final Collection<MessageToolBean> obj) {
	...
	protected String getOutFileName() {
		return "MessageBeanConstants.java";
	}
}
