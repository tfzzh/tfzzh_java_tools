 ...
 * @dateTime May 3, 2010 1:00:40 PM
 */
public class SystemFunctionManagerImplTemplate extends BaseTemplate {
	 ...
	 * @param ldb 功能数据实例列表
	 */
	public SystemFunctionManagerImplTemplate(final List<DataBeanTool> ldb) {
		super(ldb);
	}
	...
	protected String getOutFileName() {
		return this.functionName + "DataManagerImpl.java";
	}
}
