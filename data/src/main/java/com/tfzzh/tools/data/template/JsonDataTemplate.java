 ...
 * @dateTime May 9, 2010 6:55:19 PM
 */
public class JsonDataTemplate extends BaseTableTemplate {
	 ...
	 * @param bean 所需表消息
	 */
	public JsonDataTemplate(final DataBeanTool bean) {
		super(bean);
	}
	...
	protected String getOutFileName() {
		return super.data.getName() + "_data.json";
	}
